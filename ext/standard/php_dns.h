...
#define PHP_DNS_SVCB   0x00020000
#define PHP_DNS_HTTPS  0x00040000
...
# define PHP_DNS_ALL    (PHP_DNS_A|PHP_DNS_NS|PHP_DNS_CNAME|PHP_DNS_SOA|PHP_DNS_PTR|PHP_DNS_HINFO|PHP_DNS_MX|PHP_DNS_TXT|PHP_DNS_A6|PHP_DNS_SRV|PHP_DNS_NAPTR|PHP_DNS_AAAA|PHP_DNS_SVCB|PHP_DNS_HTTPS)
#else
# define PHP_DNS_NUM_TYPES	15	/* Number of DNS Types Supported by PHP currently */
# define PHP_DNS_ALL   (PHP_DNS_A|PHP_DNS_NS|PHP_DNS_CNAME|PHP_DNS_SOA|PHP_DNS_PTR|PHP_DNS_HINFO|PHP_DNS_CAA|PHP_DNS_MX|PHP_DNS_TXT|PHP_DNS_A6|PHP_DNS_SRV|PHP_DNS_NAPTR|PHP_DNS_AAAA|PHP_DNS_SVCB|PHP_DNS_HTTPS)
#endif
#endif
