 ...
 * Stub hash: f6400a24f11fb6744854c75fc58d5ea5141d07e7 */
...
static void register_file_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("STREAM_CRYPTO_METHOD_QUIC_CLIENT", STREAM_CRYPTO_METHOD_QUIC_CLIENT, CONST_PERSISTENT);
